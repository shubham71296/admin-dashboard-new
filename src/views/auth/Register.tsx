...
import { clearMessages, seller_resigter } from "../../redux/reducers/authReducer";
...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    dispatch(seller_resigter({name,email,password}))
  };
    ...
    <div className="min-h-screen bg-blue-200 flex items-center justify-center">
      <div className="bg-white shadow-xl rounded-2xl px-10 py-12 w-full max-w-md animate-fade-in">
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Seller Sign Up</h2>
