...
const sellers = [
  { name: "Rahul Sharma", img: ProfileImg, active: true,online:true },
  { name: "Raj Kumar", img: ProfileImg, active: false,online:true },
  { name: "Raju Yadav", img: ProfileImg, active: false,online:true },
];
      ...
      <div className="bg-blue-100 p-4 rounded-md">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-1/4 bg-white rounded-md shadow p-4 max-h-[400px] overflow-y-auto">
            <h1 className="font-bold text-xl text-blue-700 mb-4">Sellers</h1>
          ...
          <div className="w-full md:w-3/4 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 relative">
              ...
              <h2 className="font-semibold text-blue-800">Rahul Sharma</h2>
            </div>
